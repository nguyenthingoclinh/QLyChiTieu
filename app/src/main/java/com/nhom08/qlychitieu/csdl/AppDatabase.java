...
import com.nhom08.qlychitieu.truy_van.BankAccountDAO;
...
@Database(entities = {User.class, Setting.class, Category.class, BankAccount.class, Transaction.class, Budget.class, Statistic.class, Reminder.class}, version = 1, exportSchema = false)
